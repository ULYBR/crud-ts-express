...
const create = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const client = yield (0, client_repository_1.createClient)(data, userId);
...
const getId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const client = yield (0, client_repository_1.getClientById)(
        req.params.id,
      );
      if (!client) {
...
const update = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const client = yield (0, client_repository_1.updateClient)(
        req.params.id,
        req.body,
      );
      if (!client) {
